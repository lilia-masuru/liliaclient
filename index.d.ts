...
import type Lavalink from "@liliaclient1/types";
...
export interface Manager {
  ...
  on(event: "disconnect", listener: (event: Lavalink.PlayerEvent) => any): this;
  once(event: "disconnect", listener: (event: Lavalink.PlayerEvent) => any): this;
}
...
export interface FiltersOptions {
  nightcore?: TimescaleOptions;
  enghtD?: RotationOptions;
  bassboost: array[];
  vaporwave?: TimescaleOptions;
  karaoke?: object;
}
...
export class Filters {
  ...
  karaoke?: Lavalink.Filter.KaraokeFilter;
